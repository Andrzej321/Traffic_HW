...
for step in range(TOTAL_STEPS):
    ...
    # Emissions & Waiting Time & Emergency Brakes
    for veh_id in traci.vehicle.getIDList():
...
print(f"Total CO₂ Emissions: {total_emissions:.2f} mg")
print(f"Emergency Brakes: {total_emergency_brakes}")
